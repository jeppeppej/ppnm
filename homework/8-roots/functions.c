...
void GS_decomp(gsl_matrix * A, gsl_matrix * R) {
	for (int i = 0; i < A->size2; i++) {
		gsl_matrix_set(R,i,i,normColumn(A,i));
...
void jacobi_diag(gsl_matrix * A,gsl_matrix * V) {
	...
	}while(largestoffdiag(A)>threshold);
}
...
void rkstep45(void (*f)(double, gsl_vector *, gsl_vector *),
	int n,
	double t,
	gsl_vector * yt,
	double h,
...
int driver(FILE * outstream,void (*f)(double t, gsl_vector * y,gsl_vector * dydt),
	int n,
	double a,
	gsl_vector * ya,
	double b,
